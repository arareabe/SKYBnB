  ...
  return (
    <div>
      ...
      <div>
        ...
        <span>{theSpot.avgRating} · {theSpot.numReviews} {theSpot.numReviews === 1 ? 'review' : 'reviews'} {' '}</span>
      ...
      <div>
        <div>
          <span>{`Home hosted by ${theSpot.Owner?.firstName ? theSpot.Owner.firstName : 'no one'}`}</span>
